...
Fcharacter_image_idle = [
    pygame.image.load(asset("Moodify","F-right","pixil-frame-0.png")),
    pygame.image.load(asset("Moodify","F-right","pixil-frame-1.png")),
    pygame.image.load(asset("Moodify","F-right","pixil-frame-2.png")),
    pygame.image.load(asset("Moodify","F-right","pixil-frame-3.png")),
]

Fcharacter_walking_img =[
    pygame.image.load(asset("Moodify","F-walking/pixil-frame-0.png")),
    pygame.image.load(asset("Moodify","F-walking/pixil-frame-1.png")),
    pygame.image.load(asset("Moodify","F-walking/pixil-frame-2.png")),
    pygame.image.load(asset("Moodify","F-walking/pixil-frame-3.png")),
]

...
FONT = pygame.font.Font("Moodify/texts/PressStart2P-Regular.ttf", 20)

# Load settings icon
settings_icon = pygame.image.load("Moodify/settings/settings_icon.png")
settings_icon = pygame.transform.scale(settings_icon, (80, 80))

# Load character animations (4 frames)
male_frames = [pygame.image.load(f"Moodify/male/boy_pixil_frame_{i}.png") for i in range(0, 4)]
female_frames = [pygame.image.load(f"Moodify/F-right/pixil-frame-{i}.png") for i in range(0, 4)]
animation_index = 0
animation_timer = 0
animation_speed = 10

...
while running:
    ...
    if fading:
        ...
        if use_image_cloud and cloud_img: #if i'm using the worry cloud image and it loaded
            ...
            # If using drawn cloud, create a new surface for the fading effect
        ...
        if fade_text_surface: #if have a pre-rendered surface
    ...
    pygame.display.flip() #this updates the whole screen to show what is done so far.
